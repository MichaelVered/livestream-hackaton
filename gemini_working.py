#!/usr/bin/env python3
"""
Working Gemini API Integration for Real-time Video Analysis
...
class GeminiWorking:
    ...
    def initialize_gemini(self):
        ...
        try:
            # Try gemini-1.5-flash with correct configuration
...
def main():
    parser = argparse.ArgumentParser(description='Gemini Video Analysis (Working Version)')
    ...
    integration = GeminiWorking(api_key, camera_index)
    integration.frame_interval = frame_interval
    
    print("Gemini Video Analysis (Working Version)")
    print("=" * 50)
