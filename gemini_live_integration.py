...
Streams video from macOS camera to Gemini Live API and displays text descriptions.
"""
        ...
        try:
            ...
            setup_message = {
                "setup": {
                    ...
                    "systemInstruction": {
                        "parts": [{
                            "text": "You are a real-time video analysis assistant. Describe what you see in the video frames in a concise, informative way. Focus on the main objects, people, activities, and environment. Keep descriptions brief but detailed enough to be useful."
                        }]
                    }
                }
            }
...
def main():
    parser = argparse.ArgumentParser(description='Gemini Live Video Analysis')
    ...
    integration = GeminiLiveIntegration(api_key, camera_index)
    integration.frame_interval = frame_interval
    
    print("Gemini Live Video Analysis")
    print("=" * 40)
